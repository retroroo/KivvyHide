...
android.gradle_dependencies = org.xerial:sqlite-jdbc:3.36.0,androidx.core:core:1.6.0,androidx.appcompat:appcompat:1.3.1
...
android.gradle_url = https://services.gradle.org/distributions/gradle-7.6.1-bin.zip
